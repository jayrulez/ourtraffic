...
public class ViewConnection extends ContentPage
{
	...
	private ViewConnectionController viewConnectionController;
	...
	private void initialize(){
		...
		this.btnRunView = new JButton("Filter View");
	...
	public void startInit() 
	{
		...
		Thread connectionTableWorker = new Thread(this.viewConnectionController);
		connectionTableWorker.start();	
